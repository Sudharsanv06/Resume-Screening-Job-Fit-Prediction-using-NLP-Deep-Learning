...
def load_preprocessors(
    tokenizer_path="../models/tokenizer.pkl", label_encoder_path="../models/label_encoder.pkl"
):
    """
...
def predict_resume(resume_text, model, tokenizer, label_encoder, max_length=100):
    ...
    try:
        ...
        top_3_predictions = [
            {"role": label_encoder.classes_[idx], "confidence": float(predictions[idx] * 100)}
